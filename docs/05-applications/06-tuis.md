...
[Fastfetch](https://github.com/fastfetch-cli/fastfetch) shows system info at a glance. It runs automatically at shell startup, and is also accessible as _About_ in the Omabuntu Menu.
